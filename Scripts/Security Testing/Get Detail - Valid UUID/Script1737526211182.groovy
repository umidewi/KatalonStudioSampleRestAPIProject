...
TestObject getUserDetailRequest = (findTestObject('Alpha/Postman/Employee/Employee/Get Detail', [('alpha_gw_api_url') : GlobalVariable.alpha_gw_api_url
	, ('alpha_header_user_id_value') : GlobalVariable.alpha_header_user_id_value, ('alpha_token') :GlobalVariable.alpha_token]))
...
WS.verifyElementPropertyValue(userDetailResponse, 'data.username', 'adrianti')
